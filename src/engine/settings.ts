...
class Settings extends SettingsBase {
  ...
  protected override restore(diff: JSONObject | PartialJSON): void {
    ...
    super.restore(diff)
    // The Japanese entry is retained only as a structural string fallback.
    // Dialogue is published exclusively in the bespoke English edition.
    this.language = "en-mao"
  }
